...
//                .ReturnsAsync(new AuthResponse { Success = true, Token = token, RefreshToken = refreshToken });
...
//            _authServiceMock.Setup(authService => authService.RegisterAsync(email, password))
//                .ReturnsAsync(new AuthResponse { Success = false, Errors = new[] { errorMessage } });
//            var controller = new AuthController(_authServiceMock.Object);
...
//                .ReturnsAsync(new AuthResponse { Success = true, Token = "token", RefreshToken = "refresh token" });
//            var controller = new AuthController(_authServiceMock.Object);
...
//                .ReturnsAsync(new AuthResponse { Success = true, Token = newToken, RefreshToken = newRefreshToken });
//            var controller = new AuthController(_authServiceMock.Object);
